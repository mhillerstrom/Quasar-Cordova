 ...
 *
 * Please note: arrays will be transformed into objects with each idProperty (_id) as key and the item as value.
 * While this principle ensures fast manipulations of the data it actually makes it impossible to use .length
 * (easily remedied by using _.size instead). Also, you need to make any code manipulating the syncList array
 * aware of the transformation from Array -> Object.
 */
